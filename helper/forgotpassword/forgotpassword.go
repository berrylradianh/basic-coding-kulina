...
func ForgotPassword(receiver string, codeVer string) error {
				...
				<tr>
				  <td style="text-align: center">
					<a href="javascript:void(0);" title="logo" target="_blank">
					  <img width="150" src="https://i.postimg.cc/fyFjwZbg/asset-logo.png" title="logo" alt="logo" />
					</a>
				  </td>
				</tr>
				<tr>
					  ...
					  <tr>
						<td style="padding: 0 35px">
						  ...
						  <p style="color: #455056; font-size: 15px; line-height: 24px; margin: 0">
							You're receiving this e-mail because you requested a password reset for your Ecowave account. Use the following OTP to change your password. OTP is valid for 10 minutes.
						  </p>
						  <a
	...
	mailer.SetHeader("Subject", "recovery")
